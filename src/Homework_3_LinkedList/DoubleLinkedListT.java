package Homework_3_LinkedList;

public class DoubleLinkedListT<T extends Comparable<T>> {
    private Node root;
    private int size;
    ...
    private class Node {
        ...
        public void printNode(){
            System.out.print("[ ");
            if (this.prev != null)
                System.out.print("prev: " + this.prev.value + "; ");
            else
                System.out.print("prev: " + null + "; ");
            System.out.print("value: " + this.value + "; ");
            if (this.next != null)
                System.out.print("next: " + this.next.value + " ");
            else
